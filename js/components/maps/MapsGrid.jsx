...
const {loadMaps, updateMapMetadata, deleteMap, createThumbnail,
    ...
    backDetails, undoDetails, updateAttribute} = require('../../../MapStore2/web/client/actions/maps');
...
const withShareTool = require('../../../MapStore2/web/client/components/resources/enhancers/withShareTool').default;
