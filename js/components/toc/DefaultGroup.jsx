...
class DefaultGroup extends React.Component {
    ...
    render() {
        ...
        const groupHead = (
            <div className="toc-default-group-head">
                ...
                <GroupTitle
                    ...
                    setDefaultExpanded={this.props.setDefaultExpanded}
                />
            </div>
        );
        const groupChildren = (
        ...
        if (this.props.node.showComponent && !this.props.node.hide) {
            return (
                <Node className={(this.props.isDragging || this.props.node.placeholder ? "is-placeholder " : "") + "toc-default-group no-border toc-group-" + this.props.level + selected + error} sortableStyle={this.props.sortableStyle} style={this.props.style} type="group" {...other}>
