            ...
            <ButtonGroup>
                ...
                >
                    {this.props.activateTool.activateAddLayer && (status === 'DESELECT' || status === 'GROUP') ?
                        ...
                        : null}
                    {this.props.activateTool.activateAddGroup && (status === 'DESELECT') && this.getSelectedNodeDepth() <= this.props.maxDepth ?
                        <OverlayTrigger
                            key="addGroup"
                            placement="top"
                    ...
                    {this.props.activateTool.activateZoomTool && (status === 'LAYER' || status === 'GROUP' || status === 'LAYERS' || status === 'GROUPS') && currentEPSG ?
                        ...
                        : null}
                    {this.props.activateTool.activateGroupSettingsTool && (status === 'GROUP' || status === 'LAYER_LOAD_ERROR') && !this.props.layerMetadata.expanded && !this.props.wfsdownload.expanded ?
                        <OverlayTrigger
                            key="settings"
                            placement="top"
                        ...
                        : null}
                    {this.props.activateTool.activateLayerSettingsTool && (status === 'LAYER' || status === 'LAYER_LOAD_ERROR') && !this.props.layerMetadata.expanded && !this.props.wfsdownload.expanded ?
                        <OverlayTrigger
                            key="settings"
                            placement="top"
                            overlay={<Tooltip id="toc-tooltip-settings">{this.props.text.settingsTooltip[status === 'LAYER_LOAD_ERROR' ? 'LAYER' : status]}</Tooltip>}>
