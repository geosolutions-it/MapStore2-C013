...
const {searchEpic, searchOnStartEpic, searchItemSelected, zoomAndAddPointEpic} = require('../../MapStore2/web/client/epics/search');
const {defaultIconStyle} = require('../../MapStore2/web/client/utils/SearchUtils');
...
} = require("../../MapStore2/web/client/actions/additionallayers");
...
})(require("../../MapStore2/web/client/components/mapcontrols/search/SearchBar").default);
...
const SearchResultList = connect(selector, {
    ...
    addMarker: addMarker
})(require('../../MapStore2/web/client/components/mapcontrols/search/SearchResultList'));
