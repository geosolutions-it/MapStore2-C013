...
const {generalInfoFormatSelector} = require("../../MapStore2/web/client/selectors/mapInfo");
...
class LayerTree extends React.Component {
    ...
    renderTOC = () => {
        ...
        const sections = [this.props.activateToolsContainer, this.props.activateFilterLayer, this.props.activateMapTitle, this.props.activateBackgroundsTool].filter(s => s);
        ...
        return (
            <div>
                <Header
                    ...
                    showBackgrounds={this.props.activateBackgroundsTool}
...
const checkPluginsEnhancer = branch(
    ...
    withPropsOnChange(
        ["items", "activateAddLayerButton", "activateAddGroupButton", "activateLayerFilterTool", "activateSettingsTool", "FeatureEditor", "activateBackgroundsTool"],
        ({
            items = [],
            ...
            activateBackgroundsTool: activateBackgroundsTool && !!find(items, {name: "BackgroundSelector"}) || false
        })
    )
);
