...
// import { setDefaultExpanded } from "../../actions/layers";
import { changeLayerParams, addLayer, addGroup, moveNode, ADD_GROUP } from '../../../MapStore2/web/client/actions/layers';
...
describe('Test the layers reducer', () => {
    ...
    it('set default expanded', () => {
        // action targeting the Default group
        let action = {
            type: "LAYERS:SET_DEFAULT_EXPANDED",
        ...
        expect(state.groups[0].expanded).toBe(false);
    });
});
